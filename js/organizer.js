...
if(reg&&reg.captain&&regTable){
 const statusStore=read('kluArenaOrganizerRegistrations',{}); const key=`${reg.captain.id}-${reg.submittedAt}`; const status=statusStore[key]||'Pending';
